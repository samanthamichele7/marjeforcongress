<footer class="content-info bottom">
  ...
  <div class="bg-mfcDarkBlue">
    <div class="container mx-auto flex flex-wrap">
      <div class="w-full md:w-1/2 px-4 lg:pl-32 mb-4 text-center md:text-left">
        <div> <link href="https://brightest-production.s3.amazonaws.com/static/css/embed.css" rel="stylesheet" /> <div id="brightest-embed-form-9462e5e5d4b84410915c8eab1c2c95a2"></div> <script type="text/javascript"> var brightest_embedded_form_context = { formLink: "https://www.brightest.io/cause/marjeforcongress/embed/764/", target: "brightest-embed-form-9462e5e5d4b84410915c8eab1c2c95a2" }; </script> <script src="https://brightest-production.s3.amazonaws.com/static/js/embed.js"></script> </div>
        ...
        <div class="font-bold">
          <div class="flex flex-wrap">
            <a 
              ...
              target="__blank"
            >
              <i class="fab fa-twitter border border-white hover:border-mfcLightBlue h-8 w-8 flex items-center justify-center rounded-full mr-4"></i>
              @marje2020
            </a>

            <a 
              href="tel:218-353-1552"
              class="flex items-center text-white hover:text-mfcLightBlue mb-4 w-1/2"
              target="__blank"
            >
              <i class="fas fa-phone border border-white hover:border-mfcLightBlue h-8 w-8 flex items-center justify-center rounded-full mr-4"></i>
              218-353-1552
            </a>

            <a 
              href="mailto:info@marjeforcongress.com"
              class="flex items-center text-white hover:text-mfcLightBlue mb-4 w-full"
              target="__blank"
            >
              <i class="far fa-envelope border border-white hover:border-mfcLightBlue h-8 w-8 flex items-center justify-center rounded-full mr-4"></i>
              info@marjeforcongress.com
            </a>
          </div>
        </div>
      </div>
